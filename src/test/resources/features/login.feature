Feature: Login page 
  ...
  Scenario: Login with different scenario of INVALID inputs  
    ...
    And   user click on the login button
		Then  page text should contains "Lozinka zaboravljena?" 
		And   browser close
  ...
  Scenario Outline: Login Data Driven
    ...
    And   user click on the login button
		Then  page text should contains "<text>" 
		And 	browser close
...
#			|		 bojka.bg@gmail.com |  123										 | 	Lozinka treba da ima između 6 i 20 karatera.		|																							
		...
		Examples:
			...
			|         email		      |	 			password				   |				              text				    					  |													
			|		 bojka.bg@gmail.com |										  	   |							Lozinka zaboravljena?			  				|								
			|		 bojka.bg@gmail.com	| 	netacna lozinka			   |	            Lozinka zaboravljena? 							|																			   													    								 						
			|		 ivanS89@gmail.com	|		Javolimgrafiku123		   |		          Lozinka zaboravljena? 							|							
			|												|	  	!@$FDSFGEFK     	   |	            Lozinka zaboravljena?						    |
			|    Bojana             |   Javolimgrafiku123      |	            Lozinka zaboravljena?	 							|												    								
			|    bojka.bg@gmail.com | fhltrelcot67ljjk788@%^^&)| 	 		        Lozinka zaboravljena?								|
			|		 bojka.bg@gmail.com |  123										 | 			        Lozinka zaboravljena?								|		